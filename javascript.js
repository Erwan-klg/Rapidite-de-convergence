...
function plotData(dataSet)
{
	...
	context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 1, 0, 2 * Math.PI, true);context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 1, 0, 2 * Math.PI, true);context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 1, 0, 2 * Math.PI, true);
	context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 2, 0, 2 * Math.PI, true);context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 2, 0, 2 * Math.PI, true);context.arc((i * Espace_grille_X / Interval_Unite_X) + Espace_gauche_canvas + (Espace_grille_X / Interval_Unite_X), canvas.height - Espace_bas_canvas*2 - ((dataSet[i] - 0 - Val_min_Y) * (Espace_grille_Y / Interval_Unite_Y)), 2, 0, 2 * Math.PI, true);
